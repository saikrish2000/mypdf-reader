          ...
          return (
            <motion.li key={step.title} variants={fadeUp} className="relative">
              <div className="flex flex-col items-center text-center sm:items-start sm:text-left">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500/20 to-violet-500/20 text-violet-400 mb-4 border border-white/10">
                  <Icon className="h-5 w-5" />
                </div>
                <span className="text-xs font-mono text-violet-400 mb-1">0{i + 1}</span>
